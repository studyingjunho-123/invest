...
# 2번: 투자 리포트 제작
    ...
    issue = st.text_area(
        "시장 이슈 입력",
        placeholder="예: 호르무즈 해협 봉쇄 우려 / 연준 의장 교체 가능성 / AI 전력 수요 증가",
    )
...
- 관심 종목이 비어 있더라도 관련 실제 기업을 반드시 제시할 것
- 가능하면 한국 기업과 미국 기업을 구분할 것
- 기업명만 나열하지 말고 왜 관련되는지 설명할 것
...
4. 관련 기업 및 종목 분석
- 한국 기업:
  - 기업명: 관련 이유 / 수혜 또는 피해 가능성 / 확인할 포인트
- 미국 기업:
  - 기업명: 관련 이유 / 수혜 또는 피해 가능성 / 확인할 포인트
- 기타 글로벌 기업:
  - 기업명: 관련 이유 / 수혜 또는 피해 가능성 / 확인할 포인트
...
5. 관심 종목별 상세 영향
- 사용자가 입력한 관심 종목이 있다면 각각 따로 분석
- 입력이 없다면 “관심 종목 미입력”이라고 표시
